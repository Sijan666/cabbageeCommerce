...
const ProductforOurProducts = ({productsImg , className , productsTitle , productsPrice , productsBrand}) => {
    return (
        ...
        <div className={`w-full pb-5 sm:pb-7 ${className} shadow-customMade border border-[#FFFFFF] hover:border hover:border-[#80B500] group duration-300 overflow-hidden`}>
            <div className="bg-[#C8CACF] h-[200px] sm:h-[231px] w-full group-hover:bg-[#E0E2EB] duration-300 relative flex justify-center items-center overflow-hidden">
                {productsImg}
            ...
            <div className="text-center pt-3 px-2 sm:px-3">
                <h4 className='text-[#232323] text-[14px] sm:text-base font-bold font-int pt-[5px] truncate'>{productsTitle}</h4>
