...
const Product = ({ productImg, isList, productDesc, productRatings, badge, productTitle, productPrice, productOffer }) => {
    return (
                ...
                {isList && (
                    <div className="px-1 sm:px-2 mt-4">
                        ...
                        <Flex className="gap-3">
                            <button className="bg-[#80B500] hover:bg-[#6a9600] text-white px-5 py-2.5 rounded-[3px] font-nuni font-bold transition-colors duration-300 flex items-center gap-2">
                                <IoCartOutline className="text-lg" />
                                Add to Cart
                            </button>
                            <button className="bg-[#f4f6f8] text-[#444] hover:bg-[#e8ecef] px-3.5 py-2.5 rounded-[3px] transition-colors duration-300">
