...
import Container from "../Container"; // আপনার ফোল্ডার স্ট্রাকচার অনুযায়ী ইমপোর্ট পাথ ঠিক করে নেবেন
  ...
  return (
    <div className="bg-[#F7F9F2] min-h-screen py-16 md:py-24">
      <Container className="px-4 lg:px-0">
        ...
        <Flex className="flex-col lg:flex-row gap-12 lg:gap-16 bg-white rounded-[2rem] p-8 md:p-12 shadow-[0_20px_50px_rgba(0,0,0,0.05)] border border-gray-100">
