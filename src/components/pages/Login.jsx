...
const Login = () => {
  // 'login', 'register', অথবা 'forgot' স্ট্যাটাস ট্র্যাক করার জন্য
  ...
  const handleSubmit = (e) => {
    ...
    if (authType === "login") {
      ...
      setAuthType("login"); // রিসেট লিংক পাঠানোর পর আবার লগইন পেজে ব্যাক করবে
    ...
    <div className="bg-[#F7F9F2] min-h-screen py-16 md:py-24 flex items-center justify-center font-nuni">
      <Container className="px-4 lg:px-0 w-full max-w-5xl">
        <div className="bg-white rounded-[2.5rem] shadow-[0_20px_60px_rgba(0,0,0,0.06)] border border-gray-100 overflow-hidden grid grid-cols-1 lg:grid-cols-2 transition-all duration-500">
          ...
          {/* Left Side: Branding / Banner Section */}
          <div className="bg-gradient-to-br from-[#051117] to-[#122834] p-10 md:p-14 flex flex-col justify-between text-white relative overflow-hidden transition-colors duration-500">
          ...
          <div className="p-8 md:p-14 flex flex-col justify-center transition-all duration-500">
            ...
            {/* Toggle Tabs (শুধু লগইন এবং রেজিস্ট্রেশনের সময় দেখাবে) */}
            {authType !== "forgot" && (
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-5">
              ...
              {/* Name field (শুধু রেজিস্ট্রেশনের সময় দেখাবে) */}
              {authType === "register" && (
                <div className="flex flex-col gap-2 transition-all duration-300">
                  ...
                  <div className="relative flex items-center">
                    ...
                    <input 
                      ...
                      className="w-full bg-[#F4F7F0] border border-transparent focus:border-[#80B500] focus:bg-white rounded-xl pl-12 pr-5 py-4 outline-none transition-colors text-sm"
                    />
                  </div>
                </div>
              )}

              {/* Email field (সব সময় দেখাবে) */}
              ...
              {/* Password field (লগইন এবং রেজিস্ট্রেশনের সময় দেখাবে, forgot এ হাইড হয়ে যাবে) */}
              {authType !== "forgot" && (
                <div className="flex flex-col gap-2 transition-all duration-300">
              ...
              {/* Forgot Password Link (শুধু লগইনের সময় দেখাবে) */}
              {authType === "login" && (
                <div className="flex justify-between items-center text-sm mt-1">
                  ...
                  <button 
                    ...
                    className="text-[#80B500] font-bold hover:underline cursor-pointer"
                  >
                    Forgot Password?
                  </button>
                </div>
              ...
              <button 
                type="submit" 
                className="mt-4 bg-[#80B500] hover:bg-[#6c9a00] text-white font-bold py-4 rounded-xl shadow-lg shadow-[#80B500]/30 hover:shadow-xl transition-all duration-300 uppercase tracking-widest text-sm w-full cursor-pointer"
              >
            ...
            {/* Back to Sign In (শুধু Forgot Password পেজে দেখাবে) */}
            {authType === "forgot" && (
