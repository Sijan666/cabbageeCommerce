...
const Banner = () => {
  ...
  const animateActiveSlide = () => {
    ...
    // Watermark Fade
    gsap.to(".swiper-slide-active .hero-watermark", {
      opacity: 0.03,
      duration: 1.0,
      ease: "power2.out",
    });
    ...
    gsap.to(".swiper-slide-active .hero-elem", {
      y: 0,
      opacity: 1,
      duration: 0.55,
      stagger: 0.08,
    ...
    // Image Fade & Rotate
    gsap.to(".swiper-slide-active .hero-image", {
      opacity: 1,
      rotation: 0,
      duration: 0.75,
      ease: "power3.out",
                  ...
                  <Container className="px-4 sm:px-6 lg:px-8 relative z-10 w-full h-full flex flex-col justify-center">
                    <Flex className="flex-col-reverse lg:flex-row items-center justify-between gap-y-8 lg:gap-y-0 h-full">
                      ...
                      <div className="w-full lg:w-1/2 flex justify-center items-center relative h-62.5 sm:h-80 lg:h-full">
                        ...
                        <div 
                          onClick={() => handleRoute(data.slug)} 
                          className="hero-image opacity-0 relative z-10 w-[65%] sm:w-[70%] lg:w-[85%] lg:max-w-150 flex justify-center items-center cursor-pointer group"
                        >
                          <Images 
                            imgSrc={data.image} 
