...
const NewArrivals = () => {
  ...
  return (
    <div className="bg-[#F7F5EB] py-16 md:py-24 relative overflow-hidden" aria-label="New Arrivals Section">
      ...
      <Container className="px-4 lg:px-0 relative z-10">
        ...
        {loading ? (
          <div className="flex justify-center items-center py-32" role="status" aria-label="loading new arrivals">
